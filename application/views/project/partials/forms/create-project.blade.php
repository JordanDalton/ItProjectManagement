<?php
    ...
    echo Form::open(null, 'POST', array('class' => ''));
        ...
        echo Form::control_group(
                ...
                Form::select('project_category_id', $categories, array('selected' => Input::old('project_category_id')))
        );
    
        // Project name control group
        echo Form::control_group(
                Form::label('name', 'Project Name'),
                Form::text('name', Input::old('name'), array('style' => 'width:96%')), $errors->has('name') ? 'error ' : '',
        ...
        echo Form::control_group(
                ...
                Form::textarea('description', Input::old('description'), array('style' => 'width:96%')), $errors->has('description') ? 'error ' : '',
        ...
        echo Form::actions(array(
                Form::submit('Create Project', array('class' => 'btn btn-primary btn-large')),
        ));
