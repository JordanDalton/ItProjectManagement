...
Autoloader::map(array(
	...
	'Base_Ajax_Controller' 	=> path('app').'controllers/base/ajax.php',
));
...
|--------------------------------------------------------------------------
|
| Load all view composers when the application loads.
*/
...
|--------------------------------------------------------------------------
|
| Load all macros when the application loads.
*/
require __DIR__ . DS . 'start' . DS . 'macros.php';
...
|--------------------------------------------------------------------------
|
| Load all IoC containers when the application loads.
*/
require __DIR__ . DS . 'start' . DS . 'iocs.php';
...
|--------------------------------------------------------------------------
|
| Load all custom validators when the application loads.
*/
require __DIR__ . DS . 'start' . DS . 'validators.php';